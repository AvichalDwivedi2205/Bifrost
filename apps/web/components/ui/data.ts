...
export const MISSIONS: Mission[] = [
  { id: 'msn-7a4f', title: 'Q3 Outbound Launch — RecallReady AI', template: 'Launch Mission',
    status: 'running', urgency: 'high', mode: 'guarded autonomy', verify: 'hybrid',
    spent: 4.82, budget: 12, agents: ['launch-strategist-1', 'cold-email-sdr-1', 'lead-enrichment-1', 'verifier-1'],
    started: '2m 14s ago', duration: '—', tx: '5Kv9…qP2x' },
  { id: 'msn-6b1c', title: 'Lead Enrichment Sweep · ICP Cohort 12', template: 'Sales Ops',
    status: 'settled', urgency: 'medium', mode: 'full autonomy', verify: 'agent',
    spent: 8.14, budget: 10, agents: ['lead-enrichment-1', 'verifier-1'],
    started: '3h ago', duration: '27m 04s', tx: '3Nm2…vRj8' },
  { id: 'msn-5a0d', title: 'Vendor Invoice Batch Audit · 18 invoices', template: 'Finance Ops',
    status: 'settled', urgency: 'critical', mode: 'manual assist', verify: 'human',
    spent: 14.92, budget: 20, agents: ['invoice-auditor-1', 'expense-reviewer-1', 'verifier-1'],
    started: '6h ago', duration: '1h 12m', tx: '9Kx4…tL1m' },
  { id: 'msn-4c2e', title: 'API Docs Refresh · payments-service', template: 'Engineering',
    status: 'settled', urgency: 'low', mode: 'guarded autonomy', verify: 'proof',
    spent: 2.30, budget: 4, agents: ['docs-generator-1', 'verifier-1'],
    started: '1d ago', duration: '4h 22m', tx: '2Bd7…yW4e' },
  { id: 'msn-3e9a', title: 'PR Review Sprint · billing-service v2.4', template: 'Engineering',
    status: 'failed', urgency: 'high', mode: 'full autonomy', verify: 'hybrid',
    spent: 5.04, budget: 6, agents: ['pr-reviewer-1', 'deploy-gatekeeper-1'],
    started: '2d ago', duration: '52m 18s', tx: '7Gh3…kX9o' },
  { id: 'msn-2f8b', title: 'SOC 2 Quarterly Evidence Sweep', template: 'Compliance',
    status: 'settled', urgency: 'critical', mode: 'manual assist', verify: 'human',
    spent: 11.40, budget: 15, agents: ['compliance-auditor-1', 'contract-redliner-1', 'verifier-1'],
