...
- Search input for capability, domain, or name.
- Filter chips for domain, trust, and availability.
- Grid of agent cards sourced from shared demo registry.
- Each card shows:
- icon
- name
- description
...
- trust score
- mission count
- Register agent button is currently `UI-only`.
...
- Returns registry agents from shared demo registry data.
